...
ListIndex(ListObject *self, Py_ssize_t index)
{
    ...
    static PyObject *
ListSlice(ListObject *self, Py_ssize_t first, Py_ssize_t last, Py_ssize_t step,
	Py_ssize_t slicelen)
{
    PyInt	i;
    PyObject	*list;
...
ListItem(ListObject *self, PyObject* idx)
{
	...
	if (PySlice_GetIndicesEx(idx, ListLength(self),
	    ...
	    return NULL;
	return ListSlice(self, start, stop, step, slicelen);
    }
    else
    {
	...
	list_T *l, listitem_T **lis, listitem_T *lastaddedli)
{
    ...
    static int
ListAssSlice(ListObject *self, Py_ssize_t first, Py_ssize_t last,
...
ListAssItem(ListObject *self, PyObject *idx, PyObject *obj)
{
	...
	if (PySlice_GetIndicesEx(idx, ListLength(self),
				 &start, &stop, &step, &slicelen) < 0)
	    return -1;
	return ListAssSlice(self, start, stop, step, slicelen,
		obj);
    }
    else
    {

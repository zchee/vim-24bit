...
func_T *deref_func_name __ARGS((char_u *name, const int len, int check_var, int runevent));
...
int func_call __ARGS((func_T *name, typval_T *args, dict_T *selfdict, typval_T *rettv));
...
void func_unref __ARGS((func_T *name));
...
char_u *string_quote __ARGS((char_u *str, char *function));
/* vim: set ft=c : */
